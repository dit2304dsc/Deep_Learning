...
for train_index, val_index in kf.split(train_images):
    ...
    train_generator = train_datagen.flow(train_images[train_index], train_labels[train_index], batch_size=64)
    val_generator = val_datagen.flow(train_images[val_index], train_labels[val_index], batch_size=64)
